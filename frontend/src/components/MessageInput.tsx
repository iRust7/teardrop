      ...
      <div className="flex items-end gap-2">
        <div className="flex-1 relative">
          <textarea
            ...
            disabled={disabled}
            className="w-full px-4 py-3 pr-12 rounded-2xl border border-gray-300 focus:outline-none focus:border-primary-500 resize-none max-h-32 disabled:bg-gray-100 disabled:cursor-not-allowed"
            rows={1}
